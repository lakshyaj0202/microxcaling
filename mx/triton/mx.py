...
#     # convert input_ptr and zero_ptr to block ptr types
...
#     # zero_block_ptr = tl.make_block_ptr(
#     #     base=zero_ptr,
#     #     shape=(W*H),
#     #     strides=(1,),
#     #     offsets=(pid * BLOCK_SIZE,),
...
#     else:
#         scaled_in = tl.load(zero_ptr + offsets, mask) # tl.load(zero_block_ptr)  # tl.load(zero_block_ptr + offsets, mask)
